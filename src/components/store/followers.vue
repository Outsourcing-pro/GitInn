	...
	<div class="c_contentBody c_cnt_noColor">
		<div class="c_white_bg c_padding ">
			<div class="c_paddingV c_bottom_line">
				<span class="c_bold ft16">关注者</span>
			</div>
...
<script>
	...
	export default {
		...
		created() {
            ...
            axios.post(`/repos/${this.username}/${this.repoName}/watchers`,{page: this.page}).then(resp => {
